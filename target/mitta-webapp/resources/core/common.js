		...
		$.ajax({
			...
			success: function(response) {
				$('.alert, .text-danger').remove(); 
					$('#content').parent().before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> Success add products to cart <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
